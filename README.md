...
This package includes a macOS build workflow at `.github/workflows/build-mac-installer.yml`. Use GitHub Actions to build unsigned `.dmg` and `.zip` artifacts for Apple Silicon (`arm64`) and Intel (`x64`) Macs. See `MAC_INSTALLER_BUILD.md`.
